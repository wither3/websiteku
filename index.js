...
const {spot, lovetik, gamertagInfo, tikdownmusdown, enderTikDl, tikvid, snapTikDownload, tiktokio, tikwm, snapsave, scrapeTikViewer, onedl, onedown} = require('./codenya/scraper.js');
...
try{
const hasil = await onedown(link);
res.json(hasil);
} catch(error){
res.json(error);
}
