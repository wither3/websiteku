...
<div style="display:flex; text-align:center;
  align-items: center;
  justify-content: center; overflow-x:auto; width:99%;">
 ...
 <div style="margin-left:5px; margin-right:5px; display:flex; width:98%;">
 ...
 <div style="margin-left:5px; margin-right:5px; display:flex; padding-top:3px; width:98%;">
...
<button class="tombolDown2" onclick="window.location.href='${data.video.wmplay}'"><div class="font-text" style="font-family: 'Patrick Hand', cursive;">DOWNLOAD WATERMARK</div></button>
  ...
  <center>
<div class="inideskripsi">
<p>${data.video.judul}</p>
    </div>
